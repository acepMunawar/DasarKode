...
public class MysqlMateri11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mysql_materi11, container, false);
        //first sound button
        ...
        firstMediaPlayer = MediaPlayer.create(getActivity(), R.raw.mysqltweleft);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentMenuMateriMsyql fragmentTreeMateri = new FragmentMenuMateriMsyql();
