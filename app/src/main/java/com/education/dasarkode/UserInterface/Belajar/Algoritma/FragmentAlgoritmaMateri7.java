 ...
 */
public class FragmentAlgoritmaMateri7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_algoritma_materi7, container, false);
        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.btnPengertianArray);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLpembukaanArray);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLpembukaanArray);
        ...
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarPembukaanArray);
        return view;
    }
