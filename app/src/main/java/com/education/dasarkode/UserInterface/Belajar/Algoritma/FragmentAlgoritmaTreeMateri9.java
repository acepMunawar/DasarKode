 ...
 */
public class FragmentAlgoritmaTreeMateri9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_algoritma_materi9, container, false);
        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.FirstBtnPlay);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLpembukaanGraph);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLpembukaanGraph);
        ...
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarPembukaanGraph);
        return view;
    }
