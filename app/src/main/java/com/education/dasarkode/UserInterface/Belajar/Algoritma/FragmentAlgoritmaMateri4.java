...
public class FragmentAlgoritmaMateri4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_algoritma_materi4, container, false);
        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.btnPengertianPseudecode);
        ...
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarPembukaanPseudecode);
        btnSound1();
    return view;
