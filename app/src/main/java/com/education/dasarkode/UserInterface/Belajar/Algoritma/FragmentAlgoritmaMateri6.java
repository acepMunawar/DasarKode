...
public class FragmentAlgoritmaMateri6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_algoritma_materi6, container, false);
        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.btnPengertianSD);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLpembukaanSD);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLpembukaanSD);
        ...
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarPembukaanSD);
        return view;
    }
    //    method btn sound 1
