...
public class FragmentAlgoritmaMateri5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //first sound button
        firstButtonPlaying = (Button) view.findViewById(R.id.btnPengertianFlowchart);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLpembukaanPseudocode);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLpembukaanFlowchart);
