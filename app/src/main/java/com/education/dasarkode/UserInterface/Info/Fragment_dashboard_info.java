...
public class Fragment_dashboard_info extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.btnInfo2);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLInfo2);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLInfo2);
        firstMediaPlayer = MediaPlayer.create(getActivity(), R.raw.info);
        firstMediaPlayer.seekTo(0);
        firstTotalTime = firstMediaPlayer.getDuration();
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarInfo2);
        btnSound1();
        return view;
    }
