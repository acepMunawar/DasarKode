 ...
 */
public class FragmentAlgoritmaQueueMater8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_algoritma_mater8, container, false);

        //first sound button
        firstButtonPlaying= (Button) view.findViewById(R.id.btnPengertianTree);
        firstElapsedTimeLabel = (TextView) view.findViewById(R.id.ETLpembukaanTree);
        firstRemainingTimeLabel = (TextView) view.findViewById(R.id.RTLpembukaanTree);
        ...
        firstSeekBar =(SeekBar) view.findViewById(R.id.seekbarPembukaanTree);
        btnSound1();
        return view;
    }
