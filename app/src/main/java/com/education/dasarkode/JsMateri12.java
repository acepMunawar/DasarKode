...
public class JsMateri12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_js_materi12, container, false);
        ...
        firstMediaPlayer = MediaPlayer.create(getActivity(), R.raw.jstwelefth);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentMenuMateriJs fragmentTreeMateri = new FragmentMenuMateriJs();
